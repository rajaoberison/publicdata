#' Script for downloading and processing FAOSTAT GHG indicator data
#' Developed by Andry Rajaoberison
#' Contributors: ...
#' 
#' Necessary packages: utils, dplyr, tidyr, readr
#' 
#' Data source: https://www.fao.org/faostat/en/#data/EM
...
dataURL <- "https://bulks-faostat.fao.org/production/Climate_change_Emissions_indicators_E_All_Data.zip"
...
tmp_em <- read.csv(file.path(tmp_folder, "Climate_change_Emissions_indicators_E_All_Data_NOFLAG.csv"), check.names = F)
# get key vars
